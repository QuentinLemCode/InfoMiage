...
/*
 * Surcharge du controller interne de NewsBundle afin 
 * personaliser les templates à utiliser
 */
...
class PostController extends Controller
{
    ...
    public function renderArchive(array $criteria = array(), array $parameters = array(), Request $request = null)
    {
        ...
        $response = $this->render(sprintf('InfoMiageAppBundle:Post:archive.%s.twig', $request->getRequestFormat()), $parameters);
    ...
    public function viewAction($permalink)
    {
        ...
        return $this->render('InfoMiageAppBundle:Post:view.html.twig', array(
            'post' => $post,
            'form' => false,
            'blog' => $this->getBlog(),
        ));
    ...
    public function commentsAction($postId)
    {
        ...
        return $this->render('InfoMiageAppBundle:Post:comments.html.twig', array(
            'pager'  => $pager,
        ));
    }
    ...
    public function addCommentFormAction($postId, $form = false)
    {
        ...
        return $this->render('InfoMiageAppBundle:Post:comment_form.html.twig', array(
